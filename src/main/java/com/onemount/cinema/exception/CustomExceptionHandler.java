package com.onemount.cinema.exception;
...
//    }
    ...
    public final ResponseEntity<APIError> handleLogicException(LogicException ex, WebRequest request) {
        APIError apiError = new APIError("Logic Exception", ex.getLocalizedMessage());
        return new ResponseEntity<>(apiError, HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(NotFoundException.class)
    public final ResponseEntity<APIError> handleNotFoundException(NotFoundException ex, WebRequest request) {
        APIError apiError = new APIError("Record Not Found", ex.getLocalizedMessage(), ex.getEntity());
